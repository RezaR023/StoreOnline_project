# Generated by Django 4.1.5 on 2023-05-08 15:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('paymant_status', models.CharField(choices=[('P', 'Pending'), ('C', 'Complete'), ('F', 'Failed')], default='P', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('colletions', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='store.collection')),
